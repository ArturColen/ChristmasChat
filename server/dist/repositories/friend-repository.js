...
exports.deleteFriendRepository = exports.updateFriendRepository = exports.createFriendRepository = exports.findFriendByCodeRepository = exports.findFriendByIdRepository = exports.findAllFriendsRepository = void 0;
...
const createFriendRepository = ({ code, name, websiteLink }) => friend_js_1.default.create({
    code,
    name,
    websiteLink,
});
...
const updateFriendRepository = async (id, friendData) => {
    const updateFriend = await friend_js_1.default.findOneAndUpdate({ _id: id }, { ...friendData }, { rawResult: true });
    return updateFriend;
};
exports.updateFriendRepository = updateFriendRepository;
const deleteFriendRepository = (id) => friend_js_1.default.findOneAndDelete({ _id: id }, { rawResult: true });
