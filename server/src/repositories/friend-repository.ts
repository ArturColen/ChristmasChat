...
export const createFriendRepository = ({ code, name, websiteLink }: FriendInterface) =>
    Friend.create({
        code,
        name,
        websiteLink,
...
export const updateFriendRepository = async (
    id: string,
    friendData: Partial<FriendInterface>
...
export const deleteFriendRepository = (id: string) =>
    Friend.findOneAndDelete({ _id: id }, { rawResult: true });
